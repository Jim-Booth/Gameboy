...
namespace GameboyEmu.Core
{
    public sealed class SDLDisplay : IDisposable
    {
        ...
        private const int LedGlow = 4;
        private const int LedTexSize = (LedRadius + LedGlow) * 2;

        // Gets or sets is open.
        public bool IsOpen { get; private set; }

        // Initializes sdl display.
        public SDLDisplay()
        {
        ...
        private void LoadBackground()
        {
            ...
            IntPtr surface = SDL.SDL_LoadBMP_RW(rw, 1);
        ...
        private void CreateLedTexture()
        {
            ...
            SDL.SDL_SetTextureBlendMode(_ledTexture, 1);
        ...
        private static int MapKey(int scancode) => scancode switch
        {
            ...
            SDL.SDL_SCANCODE_Z or SDL.SDL_SCANCODE_M => 4,
            SDL.SDL_SCANCODE_X or SDL.SDL_SCANCODE_N => 5,
            SDL.SDL_SCANCODE_SPACE => 6,
            SDL.SDL_SCANCODE_RETURN => 7,
            _ => -1
        };
        ...
        private const uint ColBg = 0xFF0F380F;
        private const uint ColText = 0xFF9BBC0F;
        private const uint ColSel = 0xFF306230;
        private const uint ColSelTxt = 0xFF8BAC0F;
        private const uint ColTitle = 0xFF8BAC0F;

        // Executes try get menu jump char.
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static bool TryGetMenuJumpChar(int keySym, out char jumpChar)
        {
            if (keySym >= 'a' && keySym <= 'z')
            {
                jumpChar = (char)(keySym - 32);
                return true;
            }
        ...
        // Executes find first rom starting with.
            ...
            int initialScrollOffset = 0)
        {
            ...
            const int marqueeStartDelayFrames = 60;
        ...
        // Executes draw viewport bevel.
        private void DrawViewportBevel()
        {
            const int BevelWidth = 3;
            int vw = ScreenWidth * Scale;
            int vh = ScreenHeight * Scale;
            int x = GameX;
            int y = GameY;
    ...
    internal static class Font5x7
    {
        ...
        {
            0b00000_00000_00000_00000_00000_00000_00000UL,
            0b00100_00100_00100_00100_00100_00000_00100UL,
            0b01010_01010_01010_00000_00000_00000_00000UL,
            0b01010_01010_11111_01010_11111_01010_01010UL,
            0b00100_01111_10100_01110_00101_11110_00100UL,
            0b11000_11001_00010_00100_01000_10011_00011UL,
            0b01100_10010_10100_01000_10101_10010_01101UL,
            0b00100_00100_00100_00000_00000_00000_00000UL,
            0b00010_00100_01000_01000_01000_00100_00010UL,
            0b01000_00100_00010_00010_00010_00100_01000UL,
            0b00000_00100_10101_01110_10101_00100_00000UL,
            0b00000_00100_00100_11111_00100_00100_00000UL,
            0b00000_00000_00000_00000_00100_00100_01000UL,
            0b00000_00000_00000_11111_00000_00000_00000UL,
            0b00000_00000_00000_00000_00000_00000_00100UL,
            0b00000_00001_00010_00100_01000_10000_00000UL,
            0b01110_10001_10011_10101_11001_10001_01110UL,
            0b00100_01100_00100_00100_00100_00100_01110UL,
            0b01110_10001_00001_00010_00100_01000_11111UL,
            0b11111_00010_00100_00010_00001_10001_01110UL,
            0b00010_00110_01010_10010_11111_00010_00010UL,
            0b11111_10000_11110_00001_00001_10001_01110UL,
            0b00110_01000_10000_11110_10001_10001_01110UL,
            0b11111_00001_00010_00100_01000_01000_01000UL,
            0b01110_10001_10001_01110_10001_10001_01110UL,
            0b01110_10001_10001_01111_00001_00010_01100UL,
            0b00000_00000_00100_00000_00100_00000_00000UL,
            0b00000_00000_00100_00000_00100_00100_01000UL,
            ...
            0b01110_10001_10111_10101_10110_10000_01110UL,
            0b01110_10001_10001_11111_10001_10001_10001UL,
            0b11110_10001_10001_11110_10001_10001_11110UL,
